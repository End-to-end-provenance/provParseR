...
expect_equal(ncol(proc.proc.df), 2)
...
expect_equal(ncol(data.proc.df), 2)
...
expect_equal(ncol(proc.data.df), 2)
...
expect_equal(ncol(func.proc.df), 2)
...
expect_equal(ncol(func.lib.df), 2)
