...
expect_equal(nrow(proc.proc.df), 28)
...
expect_equal(nrow(data.proc.df), 21)
...
expect_equal(nrow(proc.data.df), 25)
...
expect_equal (nrow (variables.set), 20)

context ("Variables used")
variables.used <- get.variables.used (prov)
expect_equal (nrow (variables.used), 15)
